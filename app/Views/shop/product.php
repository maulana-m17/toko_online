                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="product-pic-zoom">
                                <img class="product-big-img" src="<?= base_url('public/uploads/'.$barang->gambar.'') ?>" alt="">
                                <div class="zoom-icon">
                            ...
                            <div class="product-thumbs">
                                <div class="product-thumbs-track ps-slider owl-carousel">
                                    <div class="pt active" data-imgbigurl="<?= base_url('public/uploads/'.$barang->gambar.'') ?>"><img
                                            src="<?= base_url('public/uploads/'.$barang->gambar.'') ?>" alt=""></div>
                                    <div class="pt" data-imgbigurl="<?= base_url('public/uploads/'.$barang->gambar.'') ?>"><img
                                            src="<?= base_url('public/uploads/'.$barang->gambar.'') ?>" alt=""></div>
                                    <div class="pt" data-imgbigurl="<?= base_url('public/uploads/'.$barang->gambar.'') ?>"><img
                                            src="<?= base_url('public/uploads/'.$barang->gambar.'') ?>" alt=""></div>
                                    <div class="pt" data-imgbigurl="<?= base_url('public/uploads/'.$barang->gambar.'') ?>"><img
